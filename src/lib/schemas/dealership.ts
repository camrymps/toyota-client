...
export namespace DealershipSchema {
  ...
  export const ResponseBodySchema = z.object({
    ...
    dealers: z.array(Dealership).nullish(),
    code: z.number().nullish(),
    success: z.boolean().nullish(),
    searchZipCode: z.string().nullish(),
    searchStrategy: z.string().nullish(),
    totalDealer: z.number().nullish(),
    generalMessage: z.string().nullish()
  });
